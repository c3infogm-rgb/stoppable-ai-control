...
def main() -> int:
    ...
    for case in load_cases():
        ...
        rows.append((case["case_id"], case["variant_axis"], result.verdict, classify_variant(result)))
    ...
    print(
        " | ".join(
            [alternate["case_id"], alternate["variant_axis"], negative.verdict, classify_variant(negative)]
        )
    )
    return 0
